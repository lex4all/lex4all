...
Figure~\ref{fig:mainform} shows the main window of the lex4all lexicon builder. This window displays the terms the user has specified and the number of audio samples that the user has selected for each word. The text and audio for each word can be modified in another form accessed by clicking the ``Edit'' button next to the word in question. 
